...
class Quizz
{
     ...
     * Set idQuizz
     *
     * @param \Mooc\CourseBundle\Entity\QuizzContent $idQuizz
     * @return Quizz
     */
    public function setIdQuizz(\Mooc\CourseBundle\Entity\QuizzContent $idQuizz)
    {
     ...
     * Get idQuizz
     *
     * @return \Mooc\CourseBundle\Entity\QuizzContent 
     */
