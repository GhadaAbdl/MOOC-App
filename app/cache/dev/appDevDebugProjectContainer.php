...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'admin.courses' => 'getAdmin_CoursesService',
            'admin.users' => 'getAdmin_UsersService',
            ...
            'sonata.block.service.stat' => 'getSonata_Block_Service_StatService',
     ...
     *
     * @return \PiBundle\Admin\BlogPostAdmin A PiBundle\Admin\BlogPostAdmin instance.
     */
    protected function getAdmin_BlogPostService()
    {
        $instance = new \PiBundle\Admin\BlogPostAdmin('admin.blog_post', 'PiBundle\\Entity\\BlogPost', 'SonataAdminBundle:CRUD');
     ...
     *
     * @return \PiBundle\Admin\CategoryAdmin A PiBundle\Admin\CategoryAdmin instance.
     */
    protected function getAdmin_CategoryService()
    {
        $instance = new \PiBundle\Admin\CategoryAdmin('admin.category', 'PiBundle\\Entity\\Category', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'admin.courses' service.
     *
     * @return \PiBundle\Admin\CoursesAdmin A PiBundle\Admin\CoursesAdmin instance.
     */
    protected function getAdmin_CoursesService()
    {
        $instance = new \PiBundle\Admin\CoursesAdmin('admin.courses', 'PiBundle\\Entity\\Courses', 'SonataAdminBundle:CRUD');
     ...
     *
     * @return \PiBundle\Admin\UsersAdmin A PiBundle\Admin\UsersAdmin instance.
     */
    protected function getAdmin_UsersService()
    {
        $instance = new \PiBundle\Admin\UsersAdmin('admin.users', 'PiBundle\\Entity\\Users', 'SonataAdminBundle:CRUD');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Mooc\UserBundle\Security\Core\User\OAuthUserProvider A Mooc\UserBundle\Security\Core\User\OAuthUserProvider instance.
     */
    protected function getApp_Provider_OauthService()
    {
        return $this->services['app.provider.oauth'] = new \Mooc\UserBundle\Security\Core\User\OAuthUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebookID', 'google' => 'googleID'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'moocdb', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Mooc\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Mooc\\MoocBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Mooc\\MailBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\PiBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\Mooc\\CourseBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\Mooc\\QuizzBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Mooc\\UserBundle\\Entity');
        $c->addDriver($b, 'Mooc\\MoocBundle\\Entity');
        $c->addDriver($b, 'Mooc\\MailBundle\\Entity');
        $c->addDriver($b, 'PiBundle\\Entity');
        $c->addDriver($b, 'Mooc\\CourseBundle\\Entity');
        $c->addDriver($b, 'Mooc\\QuizzBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('MoocUserBundle' => 'Mooc\\UserBundle\\Entity', 'MoocMoocBundle' => 'Mooc\\MoocBundle\\Entity', 'MoocMailBundle' => 'Mooc\\MailBundle\\Entity', 'PiBundle' => 'PiBundle\\Entity', 'MoocCourseBundle' => 'Mooc\\CourseBundle\\Entity', 'MoocQuizzBundle' => 'Mooc\\QuizzBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f7fc341512093278d22a18066a57899618acf0ec48cab248ab296b7d5ef5171e');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Mooc\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Mooc\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Mooc\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Mooc\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Mooc\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '1722477904656254', 'client_secret' => '6f376de3f89cd54ad1b9808afeebe4b7', 'scope' => 'email, public_profile', 'infos_url' => 'https://graph.facebook.com/me?fields=id,name,email,picture.type(square)', 'paths' => array('email' => 'email'), 'options' => array('display' => 'page')), 'facebook', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.google'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GoogleResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '1045127214815-jahctk38vvo76hh1ujls4jou0o1839o9.apps.googleusercontent.com', 'client_secret' => 'AIzaSyAXVbTqOxVLz-JdQ_uRYOb8sMG-bC-Vrao', 'scope' => 'https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile', 'paths' => array('email' => 'email'), 'options' => array()), 'google', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.main'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array('facebook' => 'facebook', 'google' => 'google'), array('facebook' => '/connect/check-facebook', 'google' => '/login/check-google'));
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i->setOptions(array('default_target_path' => 'pidev_mooc_affichage', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $k->setOptions(array('login_path' => '/login', 'default_target_path' => 'pidev_mooc_affichage', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $l->setOptions(array('failure_path' => '/login', 'login_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $m = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($a, $f, $g, $d, 'main', $k, $l, array('check_path' => '/connect_check', 'use_forward' => false, 'require_previous_session' => true), $b, $c);
        $m->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.main'));
        $m->setCheckPaths(array(0 => '/connect/check-facebook', 1 => '/login/check-google'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $g, $d, 'main', $i, $j, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => $m, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5738ad572bb3e3.40532176', $b, $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.category', 1 => 'admin.blog_post', 2 => 'admin.users', 3 => 'admin.courses'));
        $instance->setAdminGroups(array('admin.users' => array('label' => 'Users', 'label_catalogue' => 'PiBundle', 'items' => array(0 => 'admin.users'), 'icon' => '<i class="fa fa-folder"></i>', 'item_adds' => array(), 'roles' => array()), 'admin.courses' => array('label' => 'Courses', 'label_catalogue' => 'PiBundle', 'items' => array(0 => 'admin.courses'), 'icon' => '<i class="fa fa-folder"></i>', 'item_adds' => array(), 'roles' => array())));
        $instance->setAdminClasses(array('PiBundle\\Entity\\Category' => array(0 => 'admin.category'), 'PiBundle\\Entity\\BlogPost' => array(0 => 'admin.blog_post'), 'PiBundle\\Entity\\Users' => array(0 => 'admin.users'), 'PiBundle\\Entity\\Courses' => array(0 => 'admin.courses')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.category', 1 => 'admin.blog_post', 2 => 'admin.users', 3 => 'admin.courses'), $this);
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.admin.block.admin_list', 1 => 'sonata.block.service.text', 2 => 'sonata.block.service.rss', 3 => 'sonata.admin.block.stats', 4 => 'sonata.timeline.block.timeline', 5 => 'sonata.news.block.recent_posts', 6 => 'sonata.news.block.recent_comments'));
    }
    ...
    /**
     * Gets the 'sonata.block.service.stat' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PiBundle\Block\StatBlockService A PiBundle\Block\StatBlockService instance.
     */
    protected function getSonata_Block_Service_StatService()
    {
        return $this->services['sonata.block.service.stat'] = new \PiBundle\Block\StatBlockService('sonata.block.service.stat', $this->get('templating'), $this->get('sonata.admin.pool'), $this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('3azouz3atef@gmail.com');
        $a->setPassword('titeufazz');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Mooc\\ProfilBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Mooc\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.de.yml'), 'de', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.en.yml'), 'en', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.es.yml'), 'es', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.fa.yml'), 'fa', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.fr.yml'), 'fr', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.hu.yml'), 'hu', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.it.yml'), 'it', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.nl.yml'), 'nl', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.pl.yml'), 'pl', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.ru.yml'), 'ru', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.tr.yml'), 'tr', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.uk.yml'), 'uk', 'HWIOAuthBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/translations\\HWIOAuthBundle.zh.yml'), 'zh', 'HWIOAuthBundle');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Mooc\\MoocBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Mooc\\MailBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\PiBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Mooc\\CourseBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Mooc\\ProfilBundle/Resources/views'), 'MoocProfil');
        $instance->addPath(($this->targetDirs[2].'/Resources/FOSUserBundle/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Mooc\\UserBundle/Resources/views'), 'MoocUser');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Mooc\\MailBundle/Resources/views'), 'MoocMail');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Mooc\\CourseBundle/Resources/views'), 'MoocCourse');
        $instance->addPath(($this->targetDirs[3].'\\src\\Mooc\\QuizzBundle/Resources/views'), 'MoocQuizz');
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/home'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/alluser'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/otheruser'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/quizz'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/courses'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/chapter'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/MyCourses'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/certifuser'), array(0 => 'ROLE_USER'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 1 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($this->get('app.provider.oauth'), $this->get('hwi_oauth.resource_ownermap.main'), $b), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5738ad572bb3e3.40532176'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'demo_secured_area', $c, true)), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_APRENANT' => array(0 => 'ROLE_USER'), 'ROLE_FORMATEUR' => array(0 => 'ROLE_USER'), 'ROLE_ORGANISM' => array(0 => 'ROLE_USER'), 'ROLE_PEDAGOGUE' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getSonata_Block_ManagerService()
    {
        ...
        $instance->add('sonata.block.service.stat', 'sonata.block.service.stat', array());
        ...
        $instance->add('sonata.block.service.rss', 'sonata.block.service.rss', array(0 => 'admin'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MoocProfilBundle' => 'Mooc\\ProfilBundle\\MoocProfilBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'MoocUserBundle' => 'Mooc\\UserBundle\\MoocUserBundle',
                ...
                'MoocMailBundle' => 'Mooc\\MailBundle\\MoocMailBundle',
                ...
                'MoocCourseBundle' => 'Mooc\\CourseBundle\\MoocCourseBundle',
                'MoocQuizzBundle' => 'Mooc\\QuizzBundle\\MoocQuizzBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'moocdb',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => '3azouz3atef@gmail.com',
            'mailer_password' => 'titeufazz',
            'locale' => 'en',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_FORMATEUR' => array(
                    0 => 'ROLE_USER',
                ),
                'ROLE_ORGANISM' => array(
                    0 => 'ROLE_USER',
                ),
                'ROLE_PEDAGOGUE' => array(
                    0 => 'ROLE_USER',
                ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => '3azouz3atef@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'titeufazz',
            ...
            'fos_user.model.user.class' => 'Mooc\\UserBundle\\Entity\\User',
            ...
            'sonata.core.form.types' => array(
                ...
                30 => 'form.type.entity',
                31 => 'fos_user.username_form_type',
                32 => 'fos_user.profile.form.type',
                33 => 'fos_user.registration.form.type',
                34 => 'fos_user.change_password.form.type',
                35 => 'fos_user.resetting.form.type',
